...
def main():
    ...
    cv2.namedWindow('libizhi')
    if success:
        img2=cv2.imread("img/li4.jpg",1)
        cv2.imwrite("img/li15.jpg",img2[cv2.IMWRITE_JPEG_QUALITY,100])
        img=cv2.imread("img/li15.jpg",1)
        cv2.imshow('libizhi',img)
        success,frame=cc1.read()
